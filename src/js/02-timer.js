...
//     dataDays.textContent = countDownMath.days.toString().padStart(2, '0');
//     dataHours.textContent = countDownMath.hours.toString().padStart(2, '0');
//     dataMins.textContent = countDownMath.minutes.toString().padStart(2, '0');
//     dataSecs.textContent = countDownMath.seconds.toString().padStart(2, '0');
//     if (countDown < 1000) {
//         clearInterval(timer);
